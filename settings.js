  ...
  */
  ...
  // Set Nama Own & Bot
  global.ownername = 'ᴹᴿ᭄Dimz×፝֟͜×' //ubah jadi nama mu, note tanda ' gausah di hapus!
  global.botname = '𝐃𝐢𝐦𝐳𝐁𝐨𝐭-𝐌𝐝ོ' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
  global.footer = 'ᴹᴿ᭄Dimz×፝֟͜×' //ubah jadi nama mu, note tanda ' gausah di hapus!

  // Set Kebutuhan Button & Kontak
  //ubah aja kalau ada yang gapunya gsh di hps anggap aja credits :), note tanda ' gausah di hapus!
  global.youtube = 'https://youtube.com/c/DrSteves'
  global.mygc = 'https://chat.whatsapp.com/BayC66AKCMMALfFwWIPzkx'
  global.myweb = 'https://api-Dimzzz.herokuapp.com'
  global.region = 'indonesia'

  // Set Wm
  global.packname = '© 𝐃𝐢𝐦𝐳𝐁𝐨𝐭-𝐌𝐝ོ' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
  global.author = 'ᴹᴿ᭄Dimz×፝֟͜×' //ubah jadi nama mu, note tanda ' gausah di hapus!
